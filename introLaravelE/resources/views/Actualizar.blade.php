...
<div class="card-body text-justify">
    ...
    <form action="{{ route('cliente.update', $cliente->id)}}" method="POST" onsubmit="return confirmarActualizacion()" >
        @csrf
        @method('PUT') 
        ...
        <div class="card-footer text-muted">
            <div class="d-grid gap-2 mt-2 mb-1">
                <a href="{{ route('cliente.index') }}" class="btn btn-primary">{{ __('Cancelar') }}</a>
